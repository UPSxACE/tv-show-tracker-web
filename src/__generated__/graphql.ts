...
export type GetFavoriteTvShowsQueryVariables = Exact<{
  input: FavoriteTvShowsInput;
}>;


export type GetFavoriteTvShowsQuery = { __typename?: 'Query', favoriteTvShows: { __typename: 'FavoriteTvShowsPage', total: number, pageable: { __typename: 'Pageable', pageNumber: number, pageSize: number }, content: Array<{ __typename: 'UserFavoriteTvShow', id: string, favoritedAt: string, tvShow: { __typename: 'TvShow', id: string, name: string, posterUrl: string, voteAverage: number } }> } };
...
export type SaveFavoriteTvShowMutationVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type SaveFavoriteTvShowMutation = { __typename?: 'Mutation', saveFavoriteTvShow: boolean };

export type UnfavoriteTvShowMutationVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type UnfavoriteTvShowMutation = { __typename?: 'Mutation', unfavoriteTvShow: boolean };
...
export type GetTvShowQuery = { __typename?: 'Query', getTvShow?: { __typename: 'TvShow', id: string, name: string, overview?: string | null, posterUrl: string, popularity: number, voteAverage: number, numberOfSeasons: number, numberOfEpisodes: number, firstAirDate?: string | null, lastAirDate?: string | null, inProduction: boolean, favorite?: boolean | null, seasons: Array<{ __typename: 'Season', id: string, seasonNumber: number, name: string, episodeCount: number, airDate?: string | null }>, genres: Array<{ __typename: 'Genre', id: string, name: string }>, actorCredits: Array<{ __typename: 'ActorCredit', id: string, character: string, popularity: number, actor: { __typename?: 'Actor', id: string, name: string, popularity: number, profileUrl: string } }> } | null };

export type GetTvShowFavoriteInfoQueryVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type GetTvShowFavoriteInfoQuery = { __typename?: 'Query', getTvShow?: { __typename?: 'TvShow', id: string, favorite?: boolean | null } | null };
...
export const GetFavoriteTvShowsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetFavoriteTvShows"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"FavoriteTvShowsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"favoriteTvShows"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"pageable"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"pageNumber"}},{"kind":"Field","name":{"kind":"Name","value":"pageSize"}}]}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"favoritedAt"}},{"kind":"Field","name":{"kind":"Name","value":"tvShow"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"posterUrl"}},{"kind":"Field","name":{"kind":"Name","value":"voteAverage"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetFavoriteTvShowsQuery, GetFavoriteTvShowsQueryVariables>;
export const DeleteAccountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteAccount"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteAccount"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"confirm"},"value":{"kind":"BooleanValue","value":true}}]}}]}]}}]} as unknown as DocumentNode<DeleteAccountMutation, DeleteAccountMutationVariables>;
...
export const SaveFavoriteTvShowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SaveFavoriteTvShow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"saveFavoriteTvShow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tvShowId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<SaveFavoriteTvShowMutation, SaveFavoriteTvShowMutationVariables>;
export const UnfavoriteTvShowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UnfavoriteTvShow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unfavoriteTvShow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tvShowId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<UnfavoriteTvShowMutation, UnfavoriteTvShowMutationVariables>;
...
export const GetTvShowFavoriteInfoDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTvShowFavoriteInfo"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getTvShow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}}]}}]}}]} as unknown as DocumentNode<GetTvShowFavoriteInfoQuery, GetTvShowFavoriteInfoQueryVariables>;
